...
int main()
{
    ...
    cout<< "1.Miracle In Hell    : Rp40.000 "<< endl;
    cout<< "2.Two Peace Blue     : Rp50.000 "<< endl;
    cout<< " *Akan Tayang "<< endl;
    cout<< "3.White Adam         : Rp??? "<< endl;
    cout<< "4.Sayap Putus        : Rp??? "<< endl;
    cout<< "5.SpiderBoy Homeless : Rp??? "<< endl;
